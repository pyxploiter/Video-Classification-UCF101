# This file is taken from pytorch official repository
# and modified according to our need
# link: https://github.com/pytorch/vision/blob/master/torchvision/models/video/resnet.py
